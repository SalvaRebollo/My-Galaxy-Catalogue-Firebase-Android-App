...
public class MenuNavegacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuInicio = (CardView) findViewById(R.id.menuInicio);
        menuMisProductos = (CardView) findViewById(R.id.menuMisProductos);
        menuMiPerfil = (CardView) findViewById(R.id.menuMiPerfil);
        menuAcercaApp = (CardView) findViewById(R.id.menuAcercaApp);
        menuCerrarSesion = (CardView) findViewById(R.id.menuCerrarSesion);

        botonPerfil = (ImageView) findViewById(R.id.botonPerfil);
        botonMisProductos = (ImageView) findViewById(R.id.botonMisProductos);
